...
var BarChart = (function (_super) {
    ...
    BarChart.prototype.wrap = function (text, width) {
        text.each(function () {
            var text = d3_1.select(this), words = text.text().split(/\s+/).reverse(), word, line = [], lineNumber = 0, lineHeight = 1.1, // ems
